...
exports.emitter.on(activity_enum_1.EventName.LOGIN, (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.emitter.on(activity_enum_1.EventName.ACCOUNT_CREATION, (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Create a new Activity document
        const newActivity = new activity_model_1.Activity({
            user: payload.user,
...
exports.emitter.on(activity_enum_1.EventName.ROLE_CREATION, (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Create a new Activity document
        const newActivity = new activity_model_1.Activity({
            user: payload.user,
