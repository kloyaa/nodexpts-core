...
router.post('/employee/v1/profile-verification', jwt_middleware_1.isAuthenticated, role_middleware_1.isAdmin, employee_controller_1.updateProfileVerifiedStatus);
