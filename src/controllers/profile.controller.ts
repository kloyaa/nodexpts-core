...
export const getProfileByLoginId = async (req: Request, res: Response): Promise<Response<any>> => {
  try {
    // Check if there are any validation errors
...
export const getAllProfiles = async (req: Request, res: Response): Promise<Response<any>> => {
  try {
...
export const me = async (req: Request & { user?: any }, res: Response): Promise<Response<any>> => {
  try {
    const pipeline = [
      // Match the User collection to find the user by their username
